...
from routes import auth , folders , files, recycle , shares, logs, search, execute, ai, api
...
app.include_router(prefix='/execute', router=execute.router)
app.include_router(prefix='/ai', router=ai.router)
